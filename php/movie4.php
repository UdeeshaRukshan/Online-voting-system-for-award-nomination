...
<body onload="slider()" > 
   ...
   <div class="banner">
      <div class="slider">
      <img src="/OVAN/images/images1/fast and furious/fast&furious_1.jpg" id="slideImg">
   </div>
   <div class="overlay">
      <div class="content">
...
<br>
      <div class="clickChange" id="changeOnclick">
         ...
         <div class="castDetails" >
            <div class="castImg">
               <img src="/OVAN/images/images1/fast and furious/Vin_Diesel.jpg">
               <p class="castN">MAIN ACTOR</p>
               <p class="castN">Vin Diesel</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/fast and furious/Michelle_Rodriguez.jpg">
               <p class="castN">MAIN ACTRESS</p>
               <p class="castN">Michelle Rodriguez</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/fast and furious/Justin_Lin.jpg">
               <P class="castN">DIRECTOR</P>
               <P class="castN">Justin Lin</P>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/fast and furious/Lucas_Black.jpg">
              <p class="castN">PRODUCER</p>
              <p class="castN">Lucas  Black</p>
            </div>
         </div>
   ...
   <script>
      ...
      var images = new Array(
        "/OVAN/images/images1/fast and furious/fast&furious_1.jpg",
        "/OVAN/images/images1/fast and furious/fast&furious_2.jpg",
        "/OVAN/images/images1/fast and furious/fast&furious_3.jpg"
      ...
      function Rating(){
         document.getElementById('changeOnclick').innerHTML="<h1> RATING <h1> <br> <h2>This film holds an approval rating of 83% based on 4500 reviews, with an average rating of 7.22..10/10.<h2>";
            
      
      };

      function Overview(){
         document.getElementById('changeOnclick').innerHTML="<h1>OVERVIEW</h1> <br> <b>Dom Toretto is living the quiet life off the grid with Letty and his son, but they know that danger always lurks just over the peaceful horizon. This time, that threat forces Dom to confront the sins of his past to save those he loves most. His crew soon comes together to stop a world-shattering plot by the most skilled assassin and high-performance driver they've ever encountered -- Dom's forsaken brother.<b>";
      };
