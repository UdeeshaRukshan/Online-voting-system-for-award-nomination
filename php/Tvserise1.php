...
<body onload="slider()" >
   ...
   <div class="banner">
      <div class="slider">
      <img src="/OVAN/images/images1/TV_Serise/braking_bad_1.png" id="slideImg">
   </div>
   <div class="overlay">
      <div class="content">
         <h1>BREAKING BAD</h1>
...
<br>
      <div class="clickChange" id="changeOnclick">
         ...
         <div class="castDetails" >
            <div class="castImg">
               <img src="/OVAN/images/images1/TV_Serise/TS_Cast/Tv_Serise_1/Brayan_Cranston.jpg">
               <p class="castN">MAIN ACTOR</p>
               <p class="castN">Brayan Cranston</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/TV_Serise/TS_Cast/Tv_Serise_1/Anna_Gunn.jpg">
               <p class="castN">MAIN ACTRESS</p>
               <p class="castN">Anna Gunn</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/TV_Serise/TS_Cast/Tv_Serise_1/Dean_Norris.jpg">
               <P class="castN">DIRECTOR</P>
               <P class="castN">Dean Norris</P>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/TV_Serise/TS_Cast/Tv_Serise_1/Betsy_Brandt.jpg">
              <p class="castN">PRODUCER</p>
              <p class="castN">Betsy Brandt</p>
            </div>
         </div>
   ...
   <script>
      ...
      var images = new Array(
        "/OVAN/images/images1/TV_Serise/braking_bad_1.png",
        "/OVAN/images/images1/TV_Serise/braking_bad_2.jpg",
        "/OVAN/images/images1/TV_Serise/braking_bad_3.jpg"
      ...
      function Rating(){
         document.getElementById('changeOnclick').innerHTML="<h1> RATING <h1> <br> <h2>This Tv-Serise holds an approval rating of 89% based on 75600 reviews.<h2>";
            
      
      };

      function Overview(){
         document.getElementById('changeOnclick').innerHTML="<h1>OVERVIEW</h1> <br> <b>Breaking Bad is an American crime drama television series created and produced by Vince Gilligan. Set and filmed in Albuquerque, New Mexico, the series follows Walter White (Bryan Cranston), an underpaid, overqualified, and dispirited high-school chemistry teacher who is struggling with a recent diagnosis of stage-three lung cancer. White turns to a life of crime and partners with a former student, Jesse Pinkman (Aaron Paul), to produce and distribute crystal meth to secure his family's financial future before he dies, while navigating the dangers of the criminal underworld. The show aired on AMC from January 20, 2008, to September 29, 2013, consisting of five seasons for a total of 62 episodes.<b>";
      };
