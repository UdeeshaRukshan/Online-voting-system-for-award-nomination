...
<body onload="slider()" > 
   ...
   <div class="banner">
      <div class="slider">
      <img src="/OVAN/images/images1/music/rockstar_1.jpg" id="slideImg">
   </div>
   <div class="overlay">
      <div class="content">
         <h1>Rockstar</h1>
...
<br>
      <div class="clickChange" id="changeOnclick">
         ...
         <p id="paraOV">
            ...
            'Rockstar' is a song by American rapper and singer Post Malone, featuring vocals from Atlanta-based rapper 21 Savage. It was released on September 15, 2017, by Republic Records as the lead single from Malone's second studio album Beerbongs & Bentleys (2018). The artists co-wrote the song with producers Louis Bell and Tank God.
      ...
      <div class="castDetails" >
         <div class="castImg">
            <img src="/OVAN/images/images1/music/CAST/Music_2/Post_Malone_cast1.jpg">
            <p class="castN">SINGER</p>
            <p class="castN">Post Malone</p>
         </div>
         <div class="castImg">
            <img src="/OVAN/images/images1/music/CAST/Music_2/Savage_cast2.jpg">
            <p class="castN">SONG WRITTER</p>
            <p class="castN">Savage</p>
         </div>
         <div class="castImg">
            <img src="/OVAN/images/images1/music/CAST/Music_2/Alexisonfire_cast3.jpg">
            <P class="castN">MUSIC</P>
            <P class="castN">Alexisonfire band</P>
         </div>
   ...
   <script>
      ...
      var images = new Array(
        "/OVAN/images/images1/music/rockstar_1.jpg",
        "/OVAN/images/images1/music/rockstar_2.jpg",
        "/OVAN/images/images1/music/rockstar_3.jpg"
      ...
      function Rating(){
         document.getElementById('changeOnclick').innerHTML="<h1> RATING <h1> <br> <h2>This Song holds an approval rating of 80% based on 600 reviews, with an average rating of 6.10/10.<h2>";
            
      
      };

      function Overview(){
         document.getElementById('changeOnclick').innerHTML="<h1>OVERVIEW</h1> <br> <b> 'Rockstar' is a song by American rapper and singer Post Malone, featuring vocals from Atlanta-based rapper 21 Savage. It was released on September 15, 2017, by Republic Records as the lead single from Malone's second studio album Beerbongs & Bentleys (2018). The artists co-wrote the song with producers Louis Bell and Tank God.Despite receiving mixed reviews by music critics, the track became Malone's most successful hit single to date, reaching number one on the US Billboard Hot 100, and reached the top spot in several other countries, including Australia, Canada, Greece, Portugal, Romania, Ireland, New Zealand, Sweden, Norway, Finland, Denmark and the United Kingdom. It became both Post Malone and 21 Savage's first number-one single in all the countries mentioned. The song was nominated for Record of the Year and Best Rap/Sung Performance at the 61st Annual Grammy Awards.<b>";
      };
