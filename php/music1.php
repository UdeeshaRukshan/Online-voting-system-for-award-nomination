...
<body onload="slider()" >  
   ...
   <div class="banner">
      <div class="slider">
      <img src="/OVAN/images/images1/music/dark_1.jpg" id="slideImg">
   </div>
   <div class="overlay">
      <div class="content">
         <h1>One Dance</h1>
...
<br>
      <div class="clickChange" id="changeOnclick">
         ...
         <div class="castDetails" >
            <div class="castImg">
               <img src="/OVAN/images/images1/music/CAST/Music_1/Dark_cast1.jpg">
               <p class="castN">SINGER</p>
               <p class="castN">Dark</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/music/CAST/Music_1/Rihana_Cast2.jpg">
               <p class="castN">SONG WRITTER</p>
               <p class="castN">Rihana</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/music/CAST/Music_1/Dark_cast1.jpg">
   ...
   <script>
      ...
      var images = new Array(
        "/OVAN/images/images1/music/dark_1.jpg",
        "/OVAN/images/images1/music/dark_2.jpg",
        "/OVAN/images/images1/music/dark_3.jpg"
      ...
      function Rating(){
         document.getElementById('changeOnclick').innerHTML="<h1> RATING <h1> <br> <h2>This Song holds an approval rating of 90% based on 200 reviews, with an average rating of 8.10/10.<h2>";
            
      
      };

      function Overview(){
         document.getElementById('changeOnclick').innerHTML="<h1>OVERVIEW</h1> <br> <b> 'One Dance' is a song by Canadian rapper and singer Drake from his fourth studio album Views (2016). It features guest vocals from Nigerian afrobeats artist WizKid and British singer Kyla. The artists co-wrote the dancehall and afrobeats song with its co-producers Nineteen85 and Noah '40' Shebib, with production assistance from Wizkid. Crazy Cousinz and Kyla received songwriting credits for the sampling of their 2008 UK funky song Do You Mind.'One Dance' was released for digital download on April 5, 2016, and was serviced to US urban, rhythmic, and contemporary hit radio on April 12, 2016. 'One Dance' was released shortly after the release date for Views was announced, alongside 'Pop Style'. 'One Dance' was the first of three dancehall singles to be released from Views, along with 'Controlla' and 'Too Good'.<b>";
      };
