...
<body onload="slider()" >
   ...
   <div class="banner">
      <div class="slider">
      <img src="/OVAN/images/images1/avengers infity war/avengers_1.jpg" id="slideImg">
   </div>
   <div class="overlay">
      <div class="content">
...
<br>
      <div class="clickChange" id="changeOnclick">
         ...
         <div class="castDetails" >
            <div class="castImg">
               <img src="/OVAN/images/images1/avengers infity war/robert_downey cast1.jpg">
               <p class="castN">MAIN ACTOR</p>
               <p class="castN">robert downey</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/avengers infity war/Scarlett_Johansson_cast2.jpg">
               <p class="castN">MAIN ACTRESS</p>
               <p class="castN">Scarlett Johansson</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/avengers infity war/Anthony_Russo_cast3.jpg">
               <P class="castN">DIRECTOR</P>
               <P class="castN">Anthony Russo</P>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/avengers infity war/Kevin_Feige_cast4.jpg">
   ...
   <script>
      ...
      var images = new Array(
        "/OVAN/images/images1/avengers infity war/avengers_1.jpg",
        "/OVAN/images/images1/avengers infity war/avengers_2.jpg",
        "/OVAN/images/images1/avengers infity war/avengers_3.jpg",
      ...
      function Rating(){
         document.getElementById('changeOnclick').innerHTML="<h1> RATING <h1> <br> <h2> film holds an approval rating of 95% based on 400 reviews, with an average rating of 7.10/10.<h2>";
            
      
      };

      function Overview(){
         document.getElementById('changeOnclick').innerHTML="<h1>OVERVIEW</h1> <br> <b>Iron Man, Thor, the Hulk and the rest of the Avengers unite to battle their most powerful enemy yet -- the evil Thanos. On a mission to collect all six Infinity Stones, Thanos plans to use the artifacts to inflict his twisted will on reality. The fate of the planet and existence itself has never been more uncertain as everything the Avengers have fought for has led up to this moment.<b>";
      };
