...
<body onload="slider()" >
   ...
   <div class="banner">
      <div class="slider">
      <img src="/OVAN/images/images1/john wick 2/johnwick_1.jpg" id="slideImg">
   </div>
   <div class="overlay">
      <div class="content">
         <h1>JOHN WICK 2</h1>
...
<br>
      <div class="clickChange" id="changeOnclick">
         ...
         <div class="castDetails" >
            <div class="castImg">
               <img src="/OVAN/images/images1/john wick 2/Keanu_Reeves_cast1.jpg">
               <p class="castN">MAIN ACTOR</p>
               <p class="castN">Keanu Reeves</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/john wick 2/Ruby_Rose_cast2.jpg">
               <p class="castN">MAIN ACTRESS</p>
               <p class="castN">Ruby Rose</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/john wick 2/Basil_Iwanyk_cast3.jpg">
               <P class="castN">DIRECTOR</P>
               <P class="castN">Basil Iwanyk</P>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/john wick 2/Chad _Stahelski_cast4.jpg">
              <p class="castN">PRODUCER</p>
              <p class="castN">Chad Stahelski</p>
            </div>
         </div>
   ...
   <script>
      ...
      var images = new Array(
        "/images/images1/john wick 2/johnwick_1.jpg",
        "/images/images1/john wick 2/johnwick_2.jpg",
        "/images/images1/john wick 2/johnwick_3.jpg",
      ...
      function Rating(){
         document.getElementById('changeOnclick').innerHTML="<h1> RATING <h1> <br> <h2>The film holds an approval rating of 96% based on 2563 reviews, with an average rating of 9.0.10/10.<h2>";
            
      
      };

      function Overview(){
         document.getElementById('changeOnclick').innerHTML="<h1>OVERVIEW</h1> <br> <b>Retired super-assassin John Wick's plans to resume a quiet civilian life are cut short when Italian gangster Santino D'Antonio shows up on his doorstep with a gold marker, compelling him to repay past favours. Ordered by Winston, the kingpin of secret assassin society The Continental, to respect the organisation's ancient code, Wick reluctantly accepts the assignment to travel to Rome to take out D'Antonio's sister, the ruthless capo atop the Italian Camorra crime syndicate.<b>";
      };
