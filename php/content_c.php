...
<html lang="en">
<head>
    <title>Content creators</main></title>
...
<body>
   ...
   <div class="music_m">
    ...
    <div class="container">
        ...
        <div class="box">
            <img src="/OVAN/images/images1/content_c/Mr_beast_main.jpg" width="300px" height="400px">
            <br>
            <a href="content_c1.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
            
        </div>
        <div class="box">
            <img src="/OVAN/images/images1/content_c/logan_paul_main.jpg" width="300px" height="400px">
            <br>
            <a href="content_c2.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
        </div>
        <div class="box">
            <img src="/OVAN/images/images1/content_c/pewdiepie_main.jpg" width="300px" height="400px">
            <br>
            <a href="content_c3.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
        </div>
        <div class="box">
            <img src="/OVAN/images/images1/content_c/Dude_perfect_main.jpg" width="300px" height="400px">
            <br>
            <a href="content_c4.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
        </div>
        <div class="box">
            <img src="/OVAN/images/images1/content_c/zack_king_main.jpg" width="300px" height="400px">
            <br>
            <a href="content_c5.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
        </div>
    </div>
