...
<body onload="slider()" >  
   ...
   <div class="banner">
      <div class="slider">
      <img src="/OVAN/images/images1/TV_Serise/SG_1.jpg" id="slideImg">
   </div>
   <div class="overlay">
      <div class="content">
         <h1>SQUID GAME</h1>
...
<br>
      <div class="clickChange" id="changeOnclick">
         ...
         <div class="castDetails" >
            <div class="castImg">
               <img src="/OVAN/images/images1/TV_Serise/TS_Cast/Tv_serise_5/Lee_Jung_Jae_cast1.jpg">
               <p class="castN">MAIN ACTOR</p>
               <p class="castN">Lee Jung Jae</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/TV_Serise/TS_Cast/Tv_serise_5/Lee_Yoo_Mi_cast2.jpg">
               <p class="castN">MAIN ACTRESS</p>
               <p class="castN">Lee Yoo Mi</p>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/TV_Serise/TS_Cast/Tv_serise_5/Hwang_Dong_hyuk_cast3.jpg">
               <P class="castN">DIRECTOR</P>
               <P class="castN">Hwang Dong hyuk</P>
            </div>
            <div class="castImg">
               <img src="/OVAN/images/images1/TV_Serise/TS_Cast/Tv_serise_5/Lim_Ki_Hong_cast4.jpg">
              <p class="castN">PRODUCER</p>
              <p class="castN">Lim Ki Hong</p>
            </div>
         </div>
   ...
   <script>
      ...
      var images = new Array(
        "/OVAN/images/images1/TV_Serise/SG_1.jpg",
        "/OVAN/images/images1/TV_Serise/SG_2.jpg",
        "/OVAN/images/images1/TV_Serise/SG_3.jpg",
      ...
      function Rating(){
         document.getElementById('changeOnclick').innerHTML="<h1> RATING <h1> <br> <h2>This holds an approval rating of 98% based on 400 reviews, with an average rating of 7.10/10.<h2>";
            
      
      };

      function Overview(){
         document.getElementById('changeOnclick').innerHTML="<h1>OVERVIEW</h1> <br> <b>A story of people who fail at life for various reasons, but suddenly receive a mysterious invitation to participate in a survival game to win more than 38 million US dollars. The game takes place at an isolated island and the participants are locked up until there is a final winner.<b>";
      };
