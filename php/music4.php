...
<body onload="slider()" > 
   ...
   <div class="banner">
      <div class="slider">
      <img src="/OVAN/images/images1/music/baby_1.png" id="slideImg">
   </div>
   <div class="overlay">
      <div class="content">
         <h1>justin bieber baby</h1>
...
<br>
      ...
      <div class="castDetails" >
         <div class="castImg">
            <img src="/OVAN/images/images1/music/CAST/Music_4/Justin_Bieber_cast1.jpg">
            <p class="castN">SINGER</p>
            <p class="castN">Justin Bieber</p>
         </div>
         <div class="castImg">
            <img src="/OVAN/images/images1/music/CAST/Music_4/tricky_stewart_cast2.jpg">
            <p class="castN">SONG WRITTER</p>
            <p class="castN">tricky stewart</p>
         </div>
         <div class="castImg">
            <img src="/OVAN/images/images1/music/CAST/Music_4/Justin_Bieber_cast3.jpg">
   ...
   <script>
      ...
      var images = new Array(
        "/OVAN/images/images1/music/baby_1.png",
        "/OVAN/images/images1/music/baby_2.png",
        "/OVAN/images/images1/music/baby_3.png"
      ...
      function Rating(){
         document.getElementById('changeOnclick').innerHTML="<h1> RATING <h1> <br> <h2>This Song holds an approval rating of 99% based on 400 reviews, with an average rating of 9.0.10/10.<h2>";
            
      
      };

      function Overview(){
         document.getElementById('changeOnclick').innerHTML="<h1>OVERVIEW</h1> <br> <b>'Baby' is a song by Canadian singer Justin Bieber, featuring American rapper Ludacris. It was released as the lead single on Bieber's debut album, My World 2.0. The track was written by Bieber, Ludacris, Christina Milian, Tricky Stewart (who worked with Bieber on a previous single 'One Time'), and R&B singer The-Dream, with production helmed by the latter two.It was available for digital download on January 18, 2010. The song received airplay directly after release, officially impacting mainstream and rhythmic radio on January 26, 2010. The song has received positive reviews from critics who complimented the song's effective lyrics and chorus and commended Ludacris' part and the song's ability to have an urban twist.<b>";
      };
